import { Camera, Canvas, ClearMode, Engine, GLCapabilityType, HardwareRenderer, Material, Primitive, RenderTarget, SubPrimitive, TextureCubeFace } from "@oasis-engine/core";
...
export declare class WebGLRenderer implements HardwareRenderer {
    ...
    clearRenderTarget(engine: Engine, clearMode: ClearMode, clearParam: Vector4): void;
