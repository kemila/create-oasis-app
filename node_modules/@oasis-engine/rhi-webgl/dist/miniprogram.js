...
var GLCapability = /*#__PURE__*/function () {
  ...
  _proto.canIUseCompressedTextureInternalFormat = function canIUseCompressedTextureInternalFormat(internalType) {
    var RGBA_ASTC_4X4_KHR = miniprogram$1.GLCompressedTextureInternalFormat.RGBA_ASTC_4X4_KHR,
        RGBA_ASTC_12X12_KHR = miniprogram$1.GLCompressedTextureInternalFormat.RGBA_ASTC_12X12_KHR,
        SRGB8_ALPHA8_ASTC_4X4_KHR = miniprogram$1.GLCompressedTextureInternalFormat.SRGB8_ALPHA8_ASTC_4X4_KHR,
        SRGB8_ALPHA8_ASTC_12X12_KHR = miniprogram$1.GLCompressedTextureInternalFormat.SRGB8_ALPHA8_ASTC_12X12_KHR,
        RGB_ETC1_WEBGL = miniprogram$1.GLCompressedTextureInternalFormat.RGB_ETC1_WEBGL,
        R11_EAC = miniprogram$1.GLCompressedTextureInternalFormat.R11_EAC,
        SRGB8_ALPHA8_ETC2_EAC = miniprogram$1.GLCompressedTextureInternalFormat.SRGB8_ALPHA8_ETC2_EAC,
        RGB_PVRTC_4BPPV1_IMG = miniprogram$1.GLCompressedTextureInternalFormat.RGB_PVRTC_4BPPV1_IMG,
        RGBA_PVRTC_2BPPV1_IMG = miniprogram$1.GLCompressedTextureInternalFormat.RGBA_PVRTC_2BPPV1_IMG,
        RGB_S3TC_DXT1_EXT = miniprogram$1.GLCompressedTextureInternalFormat.RGB_S3TC_DXT1_EXT,
        RGBA_S3TC_DXT5_EXT = miniprogram$1.GLCompressedTextureInternalFormat.RGBA_S3TC_DXT5_EXT;
  ...
  _proto.init = function init() {
    ...
    var standardDerivatives = miniprogram$1.GLCapabilityType.standardDerivatives,
...
var GLSprite = /*#__PURE__*/function () {
  ...
  _proto.drawSprite = function drawSprite(positionQuad, uvRect, tintColor) {
    ...
    if (this._drawSpriteCount > this._maxBatchCount) {
      miniprogram$1.Logger.warn("Sprite: sprite count overflow");
      return;
    }
    ...
    this._pushVertex(positionQuad.leftTop, new miniprogram.Vector2(u, v), color);

    this._pushVertex(positionQuad.leftBottom, new miniprogram.Vector2(u, q), color);

    this._pushVertex(positionQuad.rightBottom, new miniprogram.Vector2(p, q), color);

    this._pushVertex(positionQuad.rightBottom, new miniprogram.Vector2(p, q), color);

    this._pushVertex(positionQuad.rightTop, new miniprogram.Vector2(p, v), color);
...
miniprogram$1.Shader.create("Sprite", spriteVertShader, spriteFragmentShader);
...
var GLSpriteBatcher = /*#__PURE__*/function () {
  ...
  _proto.flush = function flush(engine, material) {
    ...
    if (!this._targetTexture) {
      miniprogram$1.Logger.error("No texture!");
      return;
    }
    ...
    var compileMacros = miniprogram$1.RenderQueue.compileMacros;
...
var WebGLRenderer = /*#__PURE__*/function () {
  ...
  _proto.clearRenderTarget = function clearRenderTarget(engine, clearMode, clearParam) {
    ...
    switch (clearMode) {
      case miniprogram$1.ClearMode.SOLID_COLOR:
        gl.clearColor(clearParam.x, clearParam.y, clearParam.z, clearParam.w);
        clearColor = clearDepth = true;
        break;

      case miniprogram$1.ClearMode.DEPTH_ONLY:
        clearDepth = true;
        break;

      case miniprogram$1.ClearMode.COLOR_ONLY:
        gl.clearColor(clearParam.x, clearParam.y, clearParam.z, clearParam.w);
        clearColor = true;
        break;

      case miniprogram$1.ClearMode.STENCIL_ONLY:
        gl.clear(gl.STENCIL_BUFFER_BIT);
        clearStencil = true;
        break;

      case miniprogram$1.ClearMode.ALL_CLEAR:
        gl.clearColor(clearParam.x, clearParam.y, clearParam.z, clearParam.w);
        clearColor = clearDepth = clearStencil = true;
        break;
    }

    if (clearColor && colorWriteMask !== miniprogram$1.ColorWriteMask.All) {
      gl.colorMask(true, true, true, true);
      lastRenderState.blendState.targetBlendState.colorWriteMask = miniprogram$1.ColorWriteMask.All;
    }
