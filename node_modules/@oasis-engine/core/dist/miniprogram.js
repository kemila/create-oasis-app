    ...
    this.items.sort(function (a, b) {
      ...
      if (aIsPrimitive && bIsPrimitive) {
        ...
        if (aRenderQueue >= exports.RenderQueueType.Transparent && bRenderQueue >= exports.RenderQueueType.Transparent) {
          var aDistance = miniprogram.Vector3.distanceSquared(aElement.component.entity.transform.worldPosition, cameraPosition);
          var bDistance = miniprogram.Vector3.distanceSquared(bElement.component.entity.transform.worldPosition, cameraPosition);
...
var EnvironmentMapLight = /*#__PURE__*/function (_Light) {
  ...
  function EnvironmentMapLight(entity) {
    ...
    _this._diffuseColor = new miniprogram.Color(0.3, 0.3, 0.3, 1);
    _this._specularColor = new miniprogram.Color(0.5, 0.5, 0.5, 1);
...
var Scene = /*#__PURE__*/function (_EngineObject) {
  ...
  function Scene(engine, name) {
    ...
    _this._destroyed = false;
    _this._rootEntities = [];
    _this._resolution = new miniprogram.Vector2();
    _this.features = [];
    _this.name = name || "";
...
var BlinnPhongMaterial = /*#__PURE__*/function (_Material) {
  ...
  function BlinnPhongMaterial(engine) {
    ...
    _this._emissiveColor = new miniprogram.Color(0, 0, 0, 1);
    _this._diffuseColor = new miniprogram.Color(1, 1, 1, 1);
    _this._specularColor = new miniprogram.Color(1, 1, 1, 1);
...
var PBRBaseMaterial = /*#__PURE__*/function (_Material) {
  ...
  function PBRBaseMaterial(engine) {
    ...
    _this._baseColor = new miniprogram.Color(1, 1, 1, 1);
    ...
    _this._PTMMatrix = new miniprogram.Matrix(0.5, 0.0, 0.0, 0.0, 0.0, 0.5, 0.0, 0.0, 0.0, 0.0, 0.5, 0.0, 0.5, 0.5, 0.5, 1.0);
...
var RenderPass = /*#__PURE__*/function () {
  ...
  function RenderPass(name, priority, renderTarget, replaceMaterial, mask, clearParam) {
    ...
    if (clearParam === void 0) {
      clearParam = new miniprogram.Vector4(0, 0, 0, 0);
    }
...
var RenderContext = /*#__PURE__*/function () {
  ...
  RenderContext._getRenderContext = function _getRenderContext(camera) {
    ...
    miniprogram.Matrix.multiply(camera.projectionMatrix, camera.viewMatrix, context._viewProjectMatrix);
    return context;
  }
  /** @internal */
  ;
...
var Camera = (_dec = dependencies(Transform), _dec(_class$6 = (_class2$3 = (_temp$6 = _class3 = /*#__PURE__*/function (_Component) {
  ...
  _proto.setClearMode = function setClearMode(clearMode, backgroundColor) {
    ...
    if (backgroundColor === void 0) {
      backgroundColor = new miniprogram.Vector4(0.25, 0.25, 0.25, 1);
    }
...
var _tempVec3 = new miniprogram.Vector3();
/** @internal */


var _tempPlane = new miniprogram.Plane();
/** @internal */


var _tepmBox = new miniprogram.BoundingBox();
/** @internal */


var _tempShpere = new miniprogram.BoundingSphere();
/**
...
PlaneCollider.prototype.raycast = function (ray, hit) {
  ...
  _tempPlane.distance = -miniprogram.Vector3.dot(this.planePoint, _tempPlane.normal);
...
var LODGroup = /*#__PURE__*/function (_Renderer) {
  ...
  _proto.render = function render(camera) {
    ...
    var dist = miniprogram.Vector3.distance(camera.entity.transform.worldPosition, this.entity.transform.worldPosition);
    var lods = this._lods;
    var activeLevel = 0;
...
var Animation = (_class$9 = (_temp$9 = /*#__PURE__*/function (_Component) {
  ...
  Animation.lerp = function lerp(outValue, startValue, endValue, alpha, outputSize) {
    switch (outputSize) {
      ...
      case 4:
        var start = _construct(miniprogram.Quaternion, startValue);

        var end = _construct(miniprogram.Quaternion, endValue);
...
var SkyBox = /*#__PURE__*/function (_GeometryRenderer) {
  ...
  function SkyBox(entity) {
    ...
    _this._matrix = new miniprogram.Matrix();
  ...
  _proto.render = function render(camera) {
    ...
    miniprogram.Matrix.multiply(view, modelMatrix, matrix);
    var e = matrix.elements;
    e[12] = e[13] = e[14] = 0;
    miniprogram.Matrix.multiply(proj, matrix, matrix);
...
var ShadowMapPass = /*#__PURE__*/function (_RenderPass) {
  ...
  function ShadowMapPass(name, priority, renderTarget, replaceMaterial, mask, light) {
    ...
    _this = _RenderPass.call(this, name, priority, renderTarget, replaceMaterial, mask, new miniprogram.Vector4(1, 1, 1, 1)) || this;
    _this.light = void 0;
    _this.light = light;
    return _this;
  }
