import { Quaternion, Vector3, Matrix3x3, Matrix, MathUtil, Vector4, Vector2, Color, BoundingBox, BoundingFrustum, Plane, BoundingSphere, Ray } from '@oasis-engine/math';
 ...
 */
var Component = (_class$2 = (_temp$2 = /*#__PURE__*/function (_EngineObject) {
...
var RenderState$1 = /*#__PURE__*/function () {
  function RenderState() {
...
var _class$5, _descriptor$5, _descriptor2$4, _descriptor3$3, _descriptor4$3, _descriptor5$2, _descriptor6$2, _descriptor7$1, _descriptor8$1, _descriptor9$1, _descriptor10$1, _descriptor11$1, _descriptor12$1, _class2$2, _temp$5;

/**
 * Renderable components.
 */
var Renderer = (_class$5 = (_temp$5 = _class2$2 = /*#__PURE__*/function (_Component) {
...
var PBRBaseMaterial = /*#__PURE__*/function (_Material) {
  ...
  function PBRBaseMaterial(engine) {
    ...
    _this._PTMMatrix = new Matrix(0.5, 0.0, 0.0, 0.0, 0.0, 0.5, 0.0, 0.0, 0.0, 0.0, 0.5, 0.0, 0.5, 0.5, 0.5, 1.0);
...
var _dec, _class$6, _class2$3, _descriptor$6, _descriptor2$5, _descriptor3$4, _descriptor4$4, _descriptor5$3, _descriptor6$3, _descriptor7$2, _descriptor8$2, _descriptor9$2, _descriptor10$2, _descriptor11$2, _descriptor12$2, _descriptor13$1, _descriptor14, _class3, _temp$6;
...
var Camera = (_dec = dependencies(Transform), _dec(_class$6 = (_class2$3 = (_temp$6 = _class3 = /*#__PURE__*/function (_Component) {
...
function _getLocalRay(collider, ray) {
  ...
  var o = new Vector3();
  Vector3.transformCoordinate(ray.origin, worldToLocal, o); // d = worldToLocal * vec4(ray.direction, 0)
...
var MeshRenderer = (_class$7 = (_temp$7 = /*#__PURE__*/function (_Renderer) {
...
var _class$8, _descriptor$8, _descriptor2$7, _descriptor3$5, _descriptor4$5, _descriptor5$4, _descriptor6$4, _descriptor7$3, _descriptor8$3, _class2$4, _temp$8;

/**
 * SkinnedMeshRenderer
 */
var SkinnedMeshRenderer = (_class$8 = (_temp$8 = _class2$4 = /*#__PURE__*/function (_MeshRenderer) {
...
var SpriteRenderer = /*#__PURE__*/function (_Renderer) {
  ...
  _proto._updatePositionQuad = function _updatePositionQuad(camera) {
    if (this.renderMode === "2D") {
      ...
      var vy = new Vector3(m[1], m[5], m[9]); //-- center pos
...
export { ABoxCollider, Collider as ACollider, ASphereCollider, AlphaMode, AmbientLight, Animation, AnimationClip, AnimationEventType as AnimationEvent, AssetPromise, AssetPromiseStatus, AssetType, BasicRenderPipeline, BlendFactor, BlendFunc, BlendOperation, BlinnPhongMaterial, BoxCollider, Buffer, BufferBindFlag, BufferGeometry, BufferUsage, BufferUtil, Camera, CircleGeometry, ClearMode, ColliderFeature, CollisionDetection, ColorWriteMask, CompFunc, CompareFunction, Component, CubeProbe, CuboidGeometry, CullFace, CullMode, CylinderGeometry, DataType, DirectLight, EXP2Fog, Engine, EngineFeature, EngineObject, Entity, EnvironmentMapLight, Event, EventDispatcher, Fog, FrontFace, GLCapabilityType, GLCompressedTextureInternalFormat, GeometryRenderer, IndexBufferBinding, IndexFormat, InternalAssetType, InterpolationType, LODGroup, Layer, Light, LightFeature, LinearFog, Loader, Logger, Material, MaterialType, Mesh, MeshRenderer, Model, ObjectValues, PBRMaterial, PBRSpecularMaterial, ParticleRenderer, ParticleRendererBlendMode, PlaneCollider, PlaneGeometry, PointLight, Primitive, PrimitiveTopology, Probe, RefObject, RefreshRate, RenderBufferColorFormat, RenderBufferDepthFormat, RenderColorTexture, RenderDepthTexture, RenderElement, RenderPass, RenderQueue, RenderQueueType, RenderState, RenderTarget, Renderer, ResourceManager, Scene, SceneFeature, ScreenQuadGeometry, Script, SetDataOptions, Shader, ShaderFactory, ShapeGeometry, Side, Skin, SkinnedMeshRenderer, SkyBox, SphereCollider, SphereGeometry, SpotLight, SpriteRenderer, StencilOperation, SubPrimitive, SystemInfo, Texture, Texture2D, TextureCubeFace, TextureCubeMap, TextureFilterMode, TextureFormat, TextureWrapMode, Time, TorusGeometry, TrailMaterial, TrailRenderer, Transform, UniformSemantic, UnlitMaterial, UpdateFlag, Util, VertexBufferBinding, VertexElement, VertexElementFormat, WrapMode, dependencies, request, resourceLoader };
