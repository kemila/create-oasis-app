...
(_dec = miniprogram.resourceLoader(miniprogram.AssetType.Buffer, ["bin", "r3bin"], false), _dec(_class = /*#__PURE__*/function (_Loader) {
...
var getDefaultMaterial = function () {
  ...
  return function (engine) {
    // if (!defaultMateril) {
    var defaultMateril = new miniprogram.BlinnPhongMaterial(engine);
    defaultMateril.emissiveColor = new miniprogram$2.Color(0.749, 0.749, 0.749, 1); // }
...
var extensionParsers = {
  KHR_lights: KHR_lights,
  KHR_materials_unlit: miniprogram.UnlitMaterial,
  KHR_materials_pbrSpecularGlossiness: miniprogram.PBRSpecularMaterial,
  ...
  if (extensionsRequired) {
    ...
    for (var _i = 0; _i < extensionsRequired.length; _i++) {
      if (Object.keys(extensionParsers).indexOf(extensionsRequired[_i]) < 0 || !extensionParsers[extensionsRequired[_i]]) {
        miniprogram.Logger.error("model has not supported required extension " + extensionsRequired[_i]);
      }
...
function parseMaterial(gltfMaterial, resources) {
  ...
  if (gltf.isGltf2 && typeof gltfMaterial.technique === "undefined") {
    ...
    switch (alphaMode) {
      case "OPAQUE":
        material.alphaMode = miniprogram.AlphaMode.Opaque;
        break;

      case "BLEND":
        material.alphaMode = miniprogram.AlphaMode.Blend;
        break;

      case "MASK":
        material.alphaMode = miniprogram.AlphaMode.CutOff;
    ...
    if (pbrMetallicRoughness) {
      ...
      if (baseColorFactor) {
        material.baseColor = _construct(miniprogram$2.Color, baseColorFactor);
      }
    ...
    if (emissiveFactor) {
      material.emissiveColor = _construct(miniprogram$2.Color, emissiveFactor);
    }
    ...
    if (isSpecular) {
      ...
      if (diffuseFactor) {
        material.baseColor = _construct(miniprogram$2.Color, diffuseFactor);
      }
      ...
      if (specularFactor) {
        material.specularColor = _construct(miniprogram$2.Color, specularFactor);
      }
    ...
    miniprogram.Logger.warn("Deprecated: Please use a model that meets the glTF 2.0 specification"); // TODO: support KHR_UNLIT_MATERIAL in the future.

    if (techniqueName === "Texture") {
      var _material = new miniprogram.UnlitMaterial(engine);
...
function parseSkin(gltfSkin, resources) {
  ...
  for (var i = 0; i < jointCount; i++) {
    ...
    skin.inverseBindMatrices[i] = _construct(miniprogram$2.Matrix, buffer.subarray(startIdx, endIdx));
  } // get joints
...
function parseAnimation(gltfAnimation, resources) {
  ...
  var animationClip = new miniprogram.AnimationClip(gltfAnimation.name || "Animation" + animationIdx);
  var duration = -1;
...
function parseNode(gltfNode, resources) {
  // TODO: undefined name?
  var entity = new miniprogram.Entity(resources.engine, gltfNode.name || "GLTF_NODE_" + nodeCount++);
...
(_dec$1 = miniprogram.resourceLoader(miniprogram.AssetType.Perfab, ["gltf", "glb"]), _dec$1(_class$1 = (_temp = /*#__PURE__*/function (_Loader) {
...
var _dec$2, _class$2;
(_dec$2 = miniprogram.resourceLoader(miniprogram.AssetType.JSON, ["json"], false), _dec$2(_class$2 = /*#__PURE__*/function (_Loader) {
...
var _dec$3, _class$3;
(_dec$3 = miniprogram.resourceLoader(miniprogram.AssetType.KTXCube, []), _dec$3(_class$3 = /*#__PURE__*/function (_Loader) {
...
var _dec$4, _class$4;
(_dec$4 = miniprogram.resourceLoader(miniprogram.AssetType.KTX, ["ktx"]), _dec$4(_class$4 = /*#__PURE__*/function (_Loader) {
...
var _dec$5, _class$5;
(_dec$5 = miniprogram.resourceLoader(miniprogram.AssetType.Texture2D, ["png", "jpg", "webp", "jpeg"]), _dec$5(_class$5 = /*#__PURE__*/function (_Loader) {
...
var _dec$6, _class$6;
(_dec$6 = miniprogram.resourceLoader(miniprogram.AssetType.TextureCube, [""]), _dec$6(_class$6 = /*#__PURE__*/function (_Loader) {
  ...
  _proto.bindMaterials = function bindMaterials(materials) {
    ...
    for (var i = 0; i < materials.length; i++) {
      ...
      if (mtlResource) {
        ...
        miniprogram.Logger.warn("GLTFResource: " + this.meta.name + " can't find asset \"material\", which id is: " + materials[i].id);
      }
    }
  ...
  for (var i = 0, l = keys.length; i < l; i++) {
    ...
    if (Array.isArray(value)) {
      if (["emissiveColor", "diffuseColor", "specularColor", "baseColor"].indexOf(key) !== -1) {
        props[key] = new miniprogram$2.Color(value[0], value[1], value[2], value[3]);
