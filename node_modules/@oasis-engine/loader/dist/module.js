import { resourceLoader, AssetType, AssetPromise, Loader, VertexElement, DataType, IndexFormat, VertexElementFormat, Material, Logger, SkinnedMeshRenderer, MeshRenderer, Entity, Animation, BlinnPhongMaterial, UnlitMaterial, PBRSpecularMaterial, EngineObject, PBRMaterial, AlphaMode, Skin, Mesh, AnimationClip, InterpolationType, Camera, Primitive, SubPrimitive, PrimitiveTopology, Buffer, BufferBindFlag, BufferUsage, IndexBufferBinding, Texture2D, GLCompressedTextureInternalFormat, TextureFormat, TextureCubeMap, TextureCubeFace, Component, GLCapabilityType, Texture, ObjectValues, EventDispatcher } from '@oasis-engine/core';
import { Color, Matrix, Vector3, Quaternion, Vector4, Vector2 } from '@oasis-engine/math';
...
(_dec = resourceLoader(AssetType.Buffer, ["bin", "r3bin"], false), _dec(_class = /*#__PURE__*/function (_Loader) {
...
function parseMaterial(gltfMaterial, resources) {
  ...
  if (gltf.isGltf2 && typeof gltfMaterial.technique === "undefined") {
    ...
    if (emissiveFactor) {
      material.emissiveColor = _construct(Color, emissiveFactor);
    }
...
function parseSkin(gltfSkin, resources) {
  ...
  for (var i = 0; i < jointCount; i++) {
    ...
    skin.inverseBindMatrices[i] = _construct(Matrix, buffer.subarray(startIdx, endIdx));
  } // get joints
...
(_dec$1 = resourceLoader(AssetType.Perfab, ["gltf", "glb"]), _dec$1(_class$1 = (_temp = /*#__PURE__*/function (_Loader) {
  ...
  return GLTFLoader;
}(Loader), _temp)) || _class$1);

var _dec$2, _class$2;
(_dec$2 = resourceLoader(AssetType.JSON, ["json"], false), _dec$2(_class$2 = /*#__PURE__*/function (_Loader) {
...
var _dec$3, _class$3;
(_dec$3 = resourceLoader(AssetType.KTXCube, []), _dec$3(_class$3 = /*#__PURE__*/function (_Loader) {
...
var _dec$4, _class$4;
(_dec$4 = resourceLoader(AssetType.KTX, ["ktx"]), _dec$4(_class$4 = /*#__PURE__*/function (_Loader) {
...
var _dec$5, _class$5;
(_dec$5 = resourceLoader(AssetType.Texture2D, ["png", "jpg", "webp", "jpeg"]), _dec$5(_class$5 = /*#__PURE__*/function (_Loader) {
...
var _dec$6, _class$6;
(_dec$6 = resourceLoader(AssetType.TextureCube, [""]), _dec$6(_class$6 = /*#__PURE__*/function (_Loader) {
...
var Oasis = (_dec$a = pluginHook({
  ...
  return Oasis;
}(EventDispatcher), _temp$4), (_applyDecoratedDescriptor(_class$a.prototype, "init", [_dec$a], Object.getOwnPropertyDescriptor(_class$a.prototype, "init"), _class$a.prototype)), _class$a));
